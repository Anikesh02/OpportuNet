...
import { Airplane } from "../RoadMap/Airplane";
import { Background } from "../RoadMap/Background";
import { Cloud } from "../RoadMap/Cloud";
import { Speed } from "../RoadMap/Speed";
import { TextSection } from "../RoadMap/TextSection";
    ...
    return [
      {
        ...
        subtitle: `Welcome to OpportuNet,
...
Flutter: Dart-based framework`,
      },
      {
        ...
        title: "Blockchain ",
        subtitle: `Cryptography: Hash functions, asymmetric/symmetric encryption
Distributed Systems: Consensus algorithms (PoW, PoS)
Smart Contract: Solidity, Vyper
Blockchain Platforms: Ethereum, Solana, Cardano
Wallet Development: Integration with blockchain platforms
